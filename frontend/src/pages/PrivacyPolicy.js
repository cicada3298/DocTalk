    ...
    >
      ...
      <Box sx={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <Typography variant="body1" sx={{ marginBottom: 3, font: "inherit" }}>
          Welcome to DocTalk App. This Privacy Policy explains how we
        ...
        <Typography variant="body1" sx={{ marginBottom: 3, font: "inherit" }}>
          ...
          <a
            ...
            href={`mailto:vaibhavchaudhary898@gmail.com`}
          >
            vaibhavchaudhary898@gmail.com.
          </a>
        </Typography>
        ...
        >
          Made with ❤️ by{" "}
          <a style={{ color: "#AB47BC" }} href="https://sonnguyenhoang.com">
            Son Nguyen
          </a>{" "}
