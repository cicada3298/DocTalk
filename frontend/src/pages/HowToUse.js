...
const HowToUse = ({ theme }) => {
  return (
    ...
    >
      ...
      >
        Welcome to <strong>DocTalk</strong>, your AI-powered document
          ...
          <ListItemText
            ...
            secondary={
              ...
              >
                ...
                by DocTalk, will use the document context to provide
                tailored answers.
              </Typography>
            }
          />
      ...
      >
        DocTalk helps you save time by summarizing long documents,
      ...
      >
        Made with ❤️ by{" "}
        <a style={{ color: "#AB47BC" }} href="https://github.com/cicada3298">
          Vaibhav Chaudhary
        </a>{" "}
        in 2024. Thank you for visiting DocTalk! 🚀
      </Typography>
    </Box>
  );
};
